...
> & {
  ...
  merchandise: Pick<
    ...
    'id' | 'availableForSale' | 'sku' | 'requiresShipping' | 'title'
  > & {
...
export type AvailableMarketCountriesQuery = {
  localization: {
    availableCountries: Array<Pick<StorefrontAPI.Country, 'isoCode'>>;
  };
};

export type ClaraProductCardFragment = Pick<
  StorefrontAPI.Product,
...
export type ClaraProductVariantFragment = Pick<
  StorefrontAPI.ProductVariant,
...
export type HomepageQuery = {
  ...
  frameProduct?: StorefrontAPI.Maybe<
    Pick<
      StorefrontAPI.Product,
      'id' | 'handle' | 'title' | 'vendor' | 'productType' | 'tags'
    > & {
...
export type CartRecommendationsFallbackQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type CartRecommendationsFallbackQuery = {
  products: {
    nodes: Array<
      Pick<
        StorefrontAPI.Product,
...
export type WallSetProductsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  h1: StorefrontAPI.Scalars['String']['input'];
  h2: StorefrontAPI.Scalars['String']['input'];
  h3: StorefrontAPI.Scalars['String']['input'];
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type WallSetProductsQuery = {
  p1?: StorefrontAPI.Maybe<
    Pick<
      StorefrontAPI.Product,
      'id' | 'handle' | 'title' | 'vendor' | 'productType' | 'tags'
    > & {
...
export type WallSetProductFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'handle' | 'title' | 'vendor' | 'productType' | 'tags'
> & {
  featuredImage?: StorefrontAPI.Maybe<
      ...
      products: {
        filters: Array<
          Pick<StorefrontAPI.Filter, 'id' | 'label'> & {
            values: Array<Pick<StorefrontAPI.FilterValue, 'count' | 'label'>>;
          }
        >;
        nodes: Array<
          Pick<
...
export type ProductQuery = {
  product?: StorefrontAPI.Maybe<
    ...
    > & {
      ...
      reviewsMetafield?: StorefrontAPI.Maybe<{
...
export type FeaturePageProductQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  handle: StorefrontAPI.Scalars['String']['input'];
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  selectedOptions:
...
export type FeaturePageProductQuery = {
  product?: StorefrontAPI.Maybe<
    Pick<
      StorefrontAPI.Product,
      | 'description'
