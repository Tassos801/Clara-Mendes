...
- [Adding prints runbook](../add-products-runbook.md) - The standard launch: one catalog file (`data/print-catalog.json`) and `npm run product` steps from artwork to live verification.
